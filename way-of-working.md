...
- [worldcup/requirements-admin.md](worldcup/requirements-admin.md) — the (not yet built) internal admin site for entering results. Not a mirror of the public site.
...
- **`worldcup/shared.css`** — all CSS shared across the three World Cup pages (base styles, table layout, toggle buttons, Rankings view styles). Changes here affect all years simultaneously.
- **`worldcup/shared.js`** — all JS shared across the three World Cup pages: match-list rendering, ELO color logic, the Rankings view (Rank/Scale), and page-view switching. Changes here affect all years simultaneously.
